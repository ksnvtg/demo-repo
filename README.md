...
## Exceptions - Винятки
Винятки - це події, які відбуваються під час виконання програми та порушують нормальний хід програмних інструкцій. Коли виникає виняток, це означає, що сталася помилка. Python надає спосіб обробки цих винятків за допомогою блоків try-except, дозволяючи розробникам витончено керувати помилками та гарантувати, що програма може продовжувати або плавно завершувати роботу.
- Блок try дозволяє перевірити бло коду на наявність помилок.
- Блок except дозволяє обробити помилку.
- Блок else дозволяє виконувати код, коли немає помилок.
- Блок finally дозволяє виконувати код, незалежно від результату блоків try і except блоки.
Приклад 
